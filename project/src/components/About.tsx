      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            I'm Gokul K, a passionate UI/UX designer with 2 years of freelance experience, dedicated to creating meaningful digital experiences that bridge the gap between user needs and business goals.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm p-8 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
              ...
              <p className="text-gray-300 mb-4">
                Starting as a self-taught designer, I've evolved into a specialist who understands both the technical and creative aspects of digital product design. My freelance journey has exposed me to diverse industries and challenging projects that have shaped my design philosophy.
              </p>
              <p className="text-gray-300">
                I believe great design is invisible - it should feel natural, intuitive, and delightful. Every project is an opportunity to solve real problems and create meaningful connections between users and products. My approach combines user research, creative thinking, and technical expertise.
              </p>
            </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-blue-900/30 to-cyan-900/20 px-8 py-4 rounded-full border border-blue-500/30">
            <div className="text-center">
